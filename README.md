...
[![npm downloads](https://img.shields.io/npm/dm/webhookforge?color=green)](https://www.npmjs.com/package/webhookforge)
...
```bash
webhookforge listen              # Start the server, tunnel, and dashboard
webhookforge auth <token>        # Save your Ngrok auth token locally
...
| Server | Node.js + Express | Non-blocking I/O, perfect for high-frequency webhook traffic |
